...
const PU_STATUS_URL='https://status.robertsspaceindustries.com/affected/persistent-universe/index.html';
...
export async function onRequestGet(context){
  ...
  const payload={
    ...
    sources:{status:STATUS_URL,ptu:PATCH_FORUM,liveBuild:PU_STATUS_URL}
  };
