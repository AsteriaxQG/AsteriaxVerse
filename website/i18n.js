(()=>{
  ...
  const FR_TO_EN={
    ...
    "Chargement…":"Loading…",
    "Catalogue chargé":"Catalog loaded",
    "Catalogue indisponible":"Catalog unavailable",
    "Impossible de charger la base.":"Unable to load the database.",
    ...
    "Le dernier lot de vaisseaux et véhicules sorti dans Star Citizen, détecté depuis les publications officielles.":"The latest group of ships and vehicles released in Star Citizen, detected from official posts.",
    "Recherche des dernières sorties…":"Finding the latest releases…",
    ...
    "Modules":"Modules",
    "Autres":"Other",
    "Armes personnelles":"Personal Weapons",
    "Propulsion":"Propulsion",
    "Systèmes":"Systems",
    "Technologie":"Technology",
    "Sous-combinaisons":"Undersuits",
    "Utilitaires":"Utility",
    "Armes de véhicules":"Vehicle Weapons",
